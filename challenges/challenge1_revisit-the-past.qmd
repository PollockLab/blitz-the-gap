...
```{=html}
<iframe width="900" height="700" src="maps/historical-challenge/amphibians_last_seen.html" title="Amphibians"></iframe>
```
...
```{=html}
<iframe width="900" height="700" src="maps/historical-challenge/last_seen_plants_map.html" title="Plants"></iframe>
```
