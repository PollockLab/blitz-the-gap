...
```{=html}
<iframe width="800" height="700" src="maps/historical-challenge/last_seen_species.html"></iframe>
```
...
```{=html}
<iframe width="800" height="700" src="https://blitzthegap.shinyapps.io/blitz_the_gap_revisit_the_past/" data-external="1"></iframe>
```
