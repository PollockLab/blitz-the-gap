...
```{=html}
<iframe width="900" height="700" src="https://pollocklab.github.io/blitz-the-gap-trailblazers/challenge_trailblazers_map.html" title="Trailblazers Challenge"></iframe>
```
