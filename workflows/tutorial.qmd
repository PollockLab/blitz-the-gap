...
terra::writeRaster(base.water, here::here("data/clean/base-layers/WaterUrbanBuiltMask.tif"))
...
terra::writeRaster(anti.base, here::here("data/clean/base-layers/anti.base.5k.tif"))
```
...
gbif = data.table::fread(here::here("data/raw/biodiversity-data/amphibians/0007149-250127130748423.csv")) |>
...
```{r, eval = F}
vel <- rast(here::here("data/raw/challenges/climate/climatevelocity_adaptwest_fwvel_ensemble_rcp85_2085.tif"))
vel<-project(vel,base.5k,"bilinear")
vel<-resample(vel,base.5k,method='near')
vel[is.na(base.5k)] <- NA
terra::writeRaster(vel, here::here("data/clean/challenges/climate/climatevelocity_adaptwest_fwvel_ensemble_rcp85_2085.tif"))
```
...
terra::writeRaster(dist.to.roads, here::here("data/clean/base-layers/dist.to.roads.tif"))
```

```{r, echo = FALSE, include=FALSE}
# hidden chunk to load datasets prepared with the code above
gbif.layers = terra::rast(here::here("data/clean/rasters/gbif.layers.amphibians.tif"))
gbif.v = terra::vect(here::here("data/clean/gbif.points.amphibians.shp"))
vel = terra::rast(here::here("data/clean/base-layers/climatevelocity_adaptwest_fwvel_ensemble_rcp85_2085.tif"))
