...
```{r}
inat_pq <- arrow::open_dataset(here::here("data/raw/biodiversity-data/iNat_non_sensitive_data_Jan2025.parquet"))
```
...
base.50k = terra::rast(here::here("data/raw/base-layers/canada.base.5k.tiff")) |>
